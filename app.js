...
if (document.getElementById('form-servico')) {
    ...
    tabelaCorpoPendentes.addEventListener('click', (e) => {
        if (e.target.classList.contains('btn-editar')) {
            ...
            formServico.elements.funcionario6.value = servicoParaEditar.nomesFuncionarios[5] || '';
    ...
    btnRegistrar.addEventListener('click', (e) => {
        ...
        const nome6 = formServico.elements.funcionario6.value;

        const nomesArray = [nome1, nome2, nome3, nome4, nome5, nome6].filter(nome => nome !== '');
